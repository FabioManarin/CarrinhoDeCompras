...
@NamedQueries({@NamedQuery(name = "Funcionario.listar", query = "SELECT funcionario FROM Funcionario funcionario"),// Metodo para listar os dados da tabela
...
public class Funcionario {
	...
	@Size(min = 5, max = 8, message = "Sua senha deve conter entre 5 a 8 caracteres")
